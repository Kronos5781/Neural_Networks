...
dense2 = Layer_Dense(6, 6)
activation2 = Activation_ReLU()
dense3 = Layer_Dense(6, 3)  # second dense layer, 3 inputs, 3 outputs
...
for iteration in range(1000000):
    ...
    dense1.weights += 0.05 * np.random.randn(2, 6)
    dense1.biases += 0.05 * np.random.randn(1, 6)
    dense2.weights += 0.05 * np.random.randn(6, 6)
    dense2.biases += 0.05 * np.random.randn(1, 6)
    dense3.weights += 0.05 * np.random.randn(6, 3)
